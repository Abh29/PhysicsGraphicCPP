 ...
 */
#ifndef FT_COLLISION_COARSE_H
#define FT_COLLISION_COARSE_H
...
public:
   ...
   */
  BoundingSphere(const glm::vec3 &centre, real_t radius);
  ...
  real_t getSize() const {
    return ((real_t)1.333333) * M_PI * radius * radius * radius;
  }
};
...
template <class BoundingVolumeClass>
unsigned
BVHNode<BoundingVolumeClass>::getPotentialContacts(PotentialContact *contacts,
                                                   unsigned limit) const {
