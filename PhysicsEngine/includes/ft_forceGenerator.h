...
public:
  ...
  Spring(const glm::vec3 &localConnectionPt, RigidBody *other,
...
public:
   ...
   * given properties.
   */
  Aero(const glm::mat3 &tensor, const glm::vec3 &position,
       const glm::vec3 *windspeed);
...
public:
   ...
   * properties.
   */
  AeroControl(const glm::mat3 &base, const glm::mat3 &min, const glm::mat3 &max,
...
public:
   ...
   */
  AngledAero(const glm::mat3 &tensor, const glm::vec3 &position,
             const glm::vec3 *windspeed);
...
public:
  ...
  Buoyancy(const glm::vec3 &cOfB, real_t maxDepth, real_t volume,
