...
ft::Shader::Shader(ft::Device::pointer &device, const std::string &shaderPath,
                   ShaderType shaderType)
    : _shaderPath(shaderPath), _shaderType(shaderType), _ftDevice(device) {
...
void ft::Shader::createShaderModule(const std::vector<char> &code) {
  ...
  if (vkCreateShaderModule(_ftDevice->getVKDevice(), &createInfo, nullptr,
