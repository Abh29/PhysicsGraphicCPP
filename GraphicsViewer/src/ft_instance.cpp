...
ft::Instance::Instance(VkApplicationInfo &applicationInfo,
    ...
    : _layers(validationLayers), _extensions(requiredExtensions) {
...
ft::Instance::~Instance() {
  if (enableValidationLayers) {
    ft::Callback::DestroyDebugUtilsMessengerEXT(_instance, _debugMessenger,
                                                nullptr);
  }
...
void ft::Instance::populateDebugMessengerCreateInfo(
