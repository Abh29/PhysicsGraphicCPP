...
ft::Window::Window(uint32_t w, uint32_t h, std::string name, GLFWframebuffersizefun resizeCallback, ft::EventListener::pointer eventListener) :
_width(w), _height(h), _name(name), _resizeCallback(resizeCallback), _ftEventListener(eventListener){
	initKeys();
	initWindow();
}
...
void ft::Window::keyCallback(GLFWwindow *window, int key, int scancode, int action, int mods) {
...
void ft::Window::scrollCallback(GLFWwindow *window, double xoffset, double yoffset) {
	auto *ftw = reinterpret_cast<ft::Window*>(glfwGetWindowUserPointer(window));
	double x,y;
	glfwGetCursorPos(window, &x, &y);
...
int ft::Window::MOUSE(MouseKeys key) const {return _mouseKeys.find(key)->second;}
int ft::Window::ACTION(KeyActions action) const {return _keyActions.find(action)->second;}
...
void ft::Window::initKeys() {
	...
	_keys.insert(std::make_pair(KeyboardKeys::KEY_LEFT_BRACKET, GLFW_KEY_LEFT_BRACKET));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_BACKSLASH, GLFW_KEY_BACKSLASH));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_RIGHT_BRACKET, GLFW_KEY_RIGHT_BRACKET));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_GRAVE_ACCENT, GLFW_KEY_GRAVE_ACCENT));
	...
	_keys.insert(std::make_pair(KeyboardKeys::KEY_SCROLL_LOCK, GLFW_KEY_SCROLL_LOCK));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_NUM_LOCK, GLFW_KEY_NUM_LOCK));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_PRINT_SCREEN, GLFW_KEY_PRINT_SCREEN));
	...
	_keys.insert(std::make_pair(KeyboardKeys::KEY_KP_DECIMAL, GLFW_KEY_KP_DECIMAL));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_KP_DIVIDE, GLFW_KEY_KP_DIVIDE));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_KP_MULTIPLY, GLFW_KEY_KP_MULTIPLY));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_KP_SUBTRACT, GLFW_KEY_KP_SUBTRACT));
	...
	_keys.insert(std::make_pair(KeyboardKeys::KEY_LEFT_SHIFT, GLFW_KEY_LEFT_SHIFT));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_LEFT_CONTROL, GLFW_KEY_LEFT_CONTROL));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_LEFT_ALT, GLFW_KEY_LEFT_ALT));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_LEFT_SUPER, GLFW_KEY_LEFT_SUPER));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_RIGHT_SHIFT, GLFW_KEY_RIGHT_SHIFT));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_RIGHT_CONTROL, GLFW_KEY_RIGHT_CONTROL));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_RIGHT_ALT, GLFW_KEY_RIGHT_ALT));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_RIGHT_SUPER, GLFW_KEY_RIGHT_SUPER));
	_keys.insert(std::make_pair(KeyboardKeys::KEY_MENU, GLFW_KEY_MENU));

	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_1, GLFW_MOUSE_BUTTON_1));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_2, GLFW_MOUSE_BUTTON_2));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_3, GLFW_MOUSE_BUTTON_3));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_4, GLFW_MOUSE_BUTTON_4));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_5, GLFW_MOUSE_BUTTON_5));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_6, GLFW_MOUSE_BUTTON_6));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_7, GLFW_MOUSE_BUTTON_7));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_8, GLFW_MOUSE_BUTTON_8));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_LAST, GLFW_MOUSE_BUTTON_LAST));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_LEFT, GLFW_MOUSE_BUTTON_LEFT));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_RIGHT, GLFW_MOUSE_BUTTON_RIGHT));
	_mouseKeys.insert(std::make_pair(MouseKeys::MOUSE_BUTTON_MIDDLE, GLFW_MOUSE_BUTTON_MIDDLE));
...
void *ft::Window::getRawWindowPointer() const {
	return _window;
}
