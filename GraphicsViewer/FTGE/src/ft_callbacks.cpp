...
VkBool32 ft::Callback::debugCallback(VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity,
	...
	switch (messageType) {
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_VERBOSE_BIT_EXT:
			std::cerr << "\033[32mvalidation layer [INFO]: " << pCallbackData->pMessage  << "\033[0m" << std::endl;
			break;
		case VK_DEBUG_UTILS_MESSAGE_SEVERITY_WARNING_BIT_EXT:
			std::cerr << "validation layer [WARN]: " << pCallbackData->pMessage << std::endl;
			break;
		default:
