...
namespace ft {
	...
	public:
		...
		DescriptorSetLayout(Device::pointer device, std::vector<VkDescriptorSetLayoutBinding> bindings);
		~DescriptorSetLayout();
	...
	public:
		...
		addDescriptorBinding(VkDescriptorType type, VkShaderStageFlags flags, int32_t count = 1,
	...
	public:
		...
		DescriptorSet(Device::pointer device, DescriptorSetLayout::pointer layout, DescriptorPool& pool);
	...
	public:
		...
		[[nodiscard]] DescriptorSet::pointer allocateSet(DescriptorSetLayout::pointer layout);
		void resetPool();
