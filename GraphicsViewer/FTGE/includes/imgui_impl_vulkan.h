...
//  [!] Renderer: User texture binding. Use 'VkDescriptorSet' as ImTextureID.
//  Read the FAQ about ImTextureID! See
//  https://github.com/ocornut/imgui/pull/914 for discussions. [X] Renderer:
//  Large meshes support (64k+ vertices) with 16-bit indices.

// Important: on 32-bit systems, user texture binding is only supported if your
// imconfig file has '#define ImTextureID ImU64'. See imgui_impl_vulkan.cpp file
// for details.
...
//     imgui_impl_vulkan.cpp compilation unit:
//     - Add '#define IMGUI_IMPL_VULKAN_NO_PROTOTYPES' in your imconfig.h file
//     - Or as a compilation flag in your build system
//     - Or uncomment here (not recommended because you'd be modifying imgui
//     sources!)
//     - Do not simply add it in a .cpp file!
// (2) Call ImGui_ImplVulkan_LoadFunctions() before ImGui_ImplVulkan_Init() with
...
IMGUI_IMPL_API void
ImGui_ImplVulkan_RemoveTexture(VkDescriptorSet descriptor_set);
...
IMGUI_IMPL_API void
ImGui_ImplVulkanH_DestroyWindow(VkInstance instance, VkDevice device,
