...
namespace ft {
	...
	public:
		...
		void addColorAttachmentToSubpass(Attachment::pointer &attachment, uint32_t subpassIndex = 0);
		void addInputAttachmentToSubpass(Attachment::pointer &attachment, uint32_t subpassIndex = 0);
		void addResolveAttachmentToSubpass(Attachment::pointer &attachment, uint32_t subpassIndex = 0);
		void addPreservedAttachmentToSubpass(Attachment::pointer &attachment, uint32_t subpassIndex = 0);
		void setDepthStencilAttachmentToSubpass(Attachment::pointer &attachment, uint32_t subpassIndex = 0);
